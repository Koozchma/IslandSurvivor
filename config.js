...
export const POPULATION_FOOD_CONSUMPTION_RATE = 4;
export const SHELTER_HEALTH_MAINTENANCE_LEVEL = 3;
export const HEALTH_DECAY_NO_SHELTER = 0.35;
export const HEALTH_DECAY_LOW_HUNGER = 0.6;
export const HUNGER_DECAY_NO_FOOD_BALANCE = 1;
